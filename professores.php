    ...
    class professoresPage extends Page
    {
        protected function DoBeforeCreate()
        {
            ...
            $this->dataset->addFields(
                array(
                    ...
                    new StringField('masp', true),
                    new StringField('nome', true),
                    new StringField('email', true),
                    new StringField('telefone', true)
                )
            );
        }
        ...
        protected function getFiltersColumns()
        {
            return array(
                ...
                new FilterColumn($this->dataset, 'masp', 'masp', 'Masp'),
        ...
        protected function AddFieldColumns(Grid $grid, $withDetails = true)
        {
            ...
            //
            // View column for masp field
            //
            $column = new TextViewColumn('masp', 'masp', 'Masp', $this->dataset);
            $column->SetOrderable(true);
            $column->setMinimalVisibility(ColumnVisibility::PHONE);
            $grid->AddViewColumn($column);
            //
        ...
        {
            //
            // Edit column for masp field
            //
            $editor = new TextEdit('masp_edit');
            $editor->SetMaxLength(10);
            $editColumn = new CustomEditColumn('Masp', 'masp', $editor, $this->dataset);
